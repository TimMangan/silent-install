...
#     update variables listed below
#     Call SilentInstall-EnableMSIDebugging (optional)
#     call SilentInstall-PrimaryInstallations
#     perform additional customizations, including but not limited to
#                 Move-key (Optional)
...
#----------------------------------------------------------------------------------
# Standard Declarations (DO NOT MODIFY HERE)
...
.SYNOPSIS
    ...
    Checks to see if the script is running elevated, and if not restarts.
.VERSION
    1.0
.DESCRIPTION
